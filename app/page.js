          ...
          <div className="grid-cols-3">
            ...
            <div className="grid-col-item">
              ...
              <div className="featured_info">
                ...
                <p>
                  With a simple, straightforward approach, you can find your carbon footprint in a few minutes!
                </p>
              </div>
            </div>
